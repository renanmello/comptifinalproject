...
public class SecurityConfig {
        ...
        return httpSecurity.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(authorize -> {
                    ...
                    authorize
                            ...
                            .requestMatchers(HttpMethod.PUT, "/api/products/*").hasAnyRole("BUSINESS")
                            .requestMatchers(HttpMethod.DELETE, "/api/products/*").hasAnyRole("BUSINESS")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:5173", "http://localhost:3000", "http://localhost:8080", "http://localhost:8080/swagger-ui.html",
